...
export class DebugComponent implements OnInit {
  ...
  constructor(private debugService: DebugService, private webcrawlerService: WebcrawlerService) { }
  ...
  async getHtml(pUrl?: string) {
    ...
    console.log(await this.webcrawlerService.getProductInformationFromAmazonUrl(url));
